...
//   // --- FIXED: initial always false, update after job loads
//   const [isApplied, setIsApplied] = useState(false);

//   // --- CHECK after job data loaded
//   // useEffect(() => {
//   //   if (user?._id && singleJob?.applications) {
...
//       );
//       if (res.data.success) {
//         setIsApplied(true); //update the local storage
...
const JobDescription = () => {
  ...
  const applyJobHandler = async () => {
    // 🛡️ AUTH CHECK: Bina login ke apply karne par redirect karega
    if (!user) {
